...
import com.oic.bookreminder.models.greendao.DaoSession;
...
public class User {
    ...
    public User(Long _id, String userId, String accessToken, String gcmToken, String displayName, String fbId, String fbAccessToken, Long fbExpiredDate, String fbEmail, String fbUserName, String privateEmail, String avatarUrl, Boolean isActivated, Integer emailNotification, String language) {
        this._id = _id;
        this.userId = userId;
    ...
    public List<Notification> getNotificationList() {
        if (notificationList == null) {
            ...
            List<Notification> notificationListNew = targetDao._queryUser_NotificationList(_id);
            synchronized (this) {
                if(notificationList == null) {
